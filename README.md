...
- Monaco-based recovery mode for projects that can only be read through the editor.
...
Some Base44 projects do not expose the direct `/code` endpoint. In that case the extension can switch files in the editor and read their Monaco models.
